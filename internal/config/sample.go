...
// SampleConfig returns a sample configuration with helpful comments
func SampleConfig() string {
	return `# LogSum Configuration File
...
// MinimalSampleConfig returns a minimal configuration template
func MinimalSampleConfig() string {
	return `# LogSum Configuration File (Minimal)
version: "1.0"
